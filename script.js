...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // --- Links fixos no Menu ---
  document
    .getElementById("link-chamado-ti")
    ?.setAttribute("href", "https://chamadoadm.netlify.app");
  document
    .getElementById("link-live")
    ?.setAttribute("href", "https://callmatinal.netlify.app");
  document
    .getElementById("link-biblioteca")
    ?.setAttribute("href", "notionpage.html");
  document.getElementById("link-website")?.setAttribute("href", "login.html");
});
